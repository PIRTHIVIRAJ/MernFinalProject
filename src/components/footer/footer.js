                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-md-3 part1'>
                                ...
                                <br /><br />
                                <p>E-commerce React Website</p>
                                <br />

                                <p><LocationOnOutlinedIcon /> <strong>Address:</strong> Sindh Pakistan</p>
                                <p><HeadphonesOutlinedIcon /> <strong>Call Us:</strong> 03053496101 </p>
                                <p><EmailOutlinedIcon /> <strong>Email:</strong> pirthiviraj96@gmail.com</p>
                                ...
                                <div className='m-auto d-flex align-items-center phWrap'>
                                    <div className='phNo d-flex align-items-center mx-5'>
                                        ...
                                        <div className='info ml-3'>
                                            <h3 className='text-g mb-0'>03053496101</h3>
